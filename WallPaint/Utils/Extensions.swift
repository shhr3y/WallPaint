...
extension UIImage {
    func getPixelColor(pos: CGPoint) -> UIColor {
        guard let dataProvider = self.cgImage?.dataProvider else { return UIColor()}
    ...
    func getPixelColors2(atLocation location: CGPoint, withFrameSize size: CGSize) -> UIColor {
